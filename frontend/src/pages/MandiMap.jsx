...
// Fix default marker icons for Leaflet with React
...
// Major Indian Mandis with coordinates
const MANDIS = [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-500 text-white px-6 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-green-100">Find agricultural markets across India</p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 mb-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-end">
              <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-2 w-full text-center">
                <p className="text-green-700 font-bold text-xl">{filtered.length}</p>
              ...
              >
                ...
                {filtered.map((mandi, i) => (
                  ...
                  >
                    <Popup>
                      <div className="p-1">
                        <h3 className="font-bold text-green-700 text-base">{mandi.name}</h3>
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-gray-400 text-xs mt-0.5">🌾 {mandi.crops.slice(0, 2).join(', ')}{mandi.crops.length > 2 ? '...' : ''}</p>
                    </div>
        ...
        {selectedMandi && (
          <div className="bg-white rounded-xl shadow-md p-5 mt-4 border-l-4 border-yellow-400">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                <p className="text-gray-500 text-xs">Crops Available</p>
